...
public abstract class LitePalBase {
	 ...
	 *            The class name to introspection.
	 * @param action
	 *            Between {@link litepal.LitePalBase#GET_ASSOCIATIONS_ACTION} and
	...
	/**
	 * Package a {@link litepal.tablemanager.model.AssociationsModel}, and add it into
	 * {@link #mAssociationModels} Collection.
	 * 
	 * @param className
	 *            The class name for {@link litepal.tablemanager.model.AssociationsModel}.
	 * @param associatedClassName
	 *            The associated class name for {@link litepal.tablemanager.model.AssociationsModel}.
	 * @param classHoldsForeignKey
	 *            The class which holds foreign key.
	 * @param associationType
	 *            The association type for {@link litepal.tablemanager.model.AssociationsModel}.
	 */
	...
	/**
	 * Package a {@link litepal.crud.model.AssociationsInfo}, and add it into
