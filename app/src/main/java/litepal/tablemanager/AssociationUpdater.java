...
public abstract class AssociationUpdater extends Creator {
	...
	/**
	 * Analysis the {@link litepal.tablemanager.model.TableModel} by the purpose of subclasses, and
	 ...
	 * @throws litepal.exceptions.DatabaseGenerateException
	 */
	 ...
	 * only used in {@link #findForeignKeyToRemove(litepal.tablemanager.model.TableModel)} when iterating
	...
	/**
	 * Judge if the tableName1 equals {@link litepal.tablemanager.model.AssociationsModel#getTableName()}
	 * and tableName2 equals {@link litepal.tablemanager.model.AssociationsModel#getAssociatedTableName()}.
	 * 
